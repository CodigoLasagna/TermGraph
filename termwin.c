...
void addColor(int bg, int fg){
	...
	#endif
	switch (fg) {
		case 0: printf("\033[0;30m"); break;
		case 1: printf("\033[0;31m"); break;
		case 2: printf("\033[0;32m"); break;
		case 3: printf("\033[0;33m"); break;
		case 4: printf("\033[0;34m"); break;
		case 5: printf("\033[0;35m"); break;
		case 6: printf("\033[0;36m"); break;
		case 7: printf("\033[0;37m"); break;
	}
	switch (bg) {
		case 0: printf("\033[40m"); break;
		case 1: printf("\033[41m"); break;
		case 2: printf("\033[42m"); break;
		case 3: printf("\033[43m"); break;
		case 4: printf("\033[44m"); break;
		case 5: printf("\033[45m"); break;
		case 6: printf("\033[46m"); break;
		case 7: printf("\033[47m"); break;
	}
}
